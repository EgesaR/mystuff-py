"""corrected id type of most tables

Revision ID: 9de69149f899
Revises: 092d90292a93
Create Date: 2026-09-14 01:17:14.336146
...
revision: str = '9de69149f899'
down_revision: Union[str, Sequence[str], None] = '092d90292a93'
...
def upgrade() -> None:
    ...
    with op.batch_alter_table('beta_signups', schema=None) as batch_op:
        ...
        batch_op.alter_column('updated_at',
               ...
               existing_nullable=False,
               existing_server_default=sa.text('(CURRENT_TIMESTAMP)'))
        batch_op.drop_index(batch_op.f('ix_beta_signups_user_id'))
        batch_op.create_index(batch_op.f('ix_beta_signups_user_id'), ['user_id'], unique=False)
...
def downgrade() -> None:
    ...
    with op.batch_alter_table('beta_signups', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_beta_signups_user_id'))
        batch_op.create_index(batch_op.f('ix_beta_signups_user_id'), ['user_id'], unique=1)
        batch_op.alter_column('updated_at',
               existing_type=sa.DateTime(timezone=True),
               type_=sa.DATETIME(),
               existing_nullable=False,
