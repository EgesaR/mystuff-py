"""Adding pre_registration table 2

Revision ID: e14177bdffc4
Revises: 3bfb2b7ed7bb
Create Date: 2026-09-14 05:50:29.125222
...
revision: str = 'e14177bdffc4'
down_revision: Union[str, Sequence[str], None] = '3bfb2b7ed7bb'
...
def upgrade() -> None:
    ...
    sa.Column('subscribed', sa.Boolean(), server_default=sa.text('0'), nullable=False),
    ...
    with op.batch_alter_table('pre_registrations', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_pre_registrations_converted_user_id'), ['converted_user_id'], unique=False)
        batch_op.create_index('ix_pre_registrations_created_at', ['created_at'], unique=False)
        batch_op.create_index(batch_op.f('ix_pre_registrations_email'), ['email'], unique=True)
        batch_op.create_index('ix_pre_registrations_verified_subscribed', ['verified', 'subscribed'], unique=False)
...
def downgrade() -> None:
    ...
    with op.batch_alter_table('pre_registrations', schema=None) as batch_op:
        batch_op.drop_index('ix_pre_registrations_verified_subscribed')
        batch_op.drop_index(batch_op.f('ix_pre_registrations_email'))
        batch_op.drop_index('ix_pre_registrations_created_at')
        batch_op.drop_index(batch_op.f('ix_pre_registrations_converted_user_id'))
